package com.avsystemgeo.cameraman.geo.converter;
...
public class LatLon2UTM {
    ...
    private double flattening = 298.2572236;
    private double equatorialRadius = 6378137;

    private double esq;
    private double e0sq;

    private char[] digraphArrayN;

    private double eastingValue;
    private double northingValue;
    private int latitudeZoneValue;
    private int longitudeZoneValue;
    ...
    public String convertLatToUTM(double latitude, double longitude) {
    ...
    public String convertLonToUTM(double latitude, double longitude) {
        verifyLatLon(latitude, longitude);
    ...
    private void convert(double latitude, double longitude) {
